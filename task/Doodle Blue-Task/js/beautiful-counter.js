...
*/
!function(t,e,n){t.fn.yuukCountDown=function(e){var n={starttime:"",endtime:"",startCallBack:t.noop,notStartCallBack:t.noop,endCallBack:t.noop},a=t.extend(n,e);return this.each(function(e,n){({timer:null,countDown:function(){var t=Math.round((new Date).getTime()/1e3),e=Math.round(new Date(a.starttime)/1e3);endTime=Math.round(new Date(a.endtime)/1e3);var n=endTime-t;return{endLeftTime:n,startLeftTime:e-t,day:parseInt(n/60/60/24),hour:parseInt(n/60/60%24),minute:parseInt(n/60%60),second:parseInt(n%60),ms:parseInt((new Date(a.endtime)-(new Date).getTime())%1e3)}},setHtml:function(e){var i=this,l=e.endLeftTime,s=e.startLeftTime,r=i.fillZero(e.day),o=i.fillZero(e.hour),c=i.fillZero(e.minute),m=i.fillZero(e.second),u=i.fillZero(e.ms.toString().substr(0,2));s>0?a.notStartCallBack&&a.notStartCallBack(e):(l>0&&(t(n).html(['<li class="item"><i class="day">'+r+"</i><span>days</span></li>",'<li class="blank">:</li>','<li class="item"><i class="hour">'+o+"</i><span>hours</span></li>",'<li class="blank">:</li>','<li class="item"><i class="minute">'+c+"</i><span>minutes</span></li>",'<li class="blank">:</li>','<li class="item"><i class="second">'+m+"</i><span>seconds</span></li>",'<li class="blank">:</li>','<li class="item"><i class="ms">'+u+"</i><span>milliseconds</span></li>"].join(" ")),a.startCallBack&&a.startCallBack(e)),l<=0&&(a.endCallBack&&a.endCallBack(e),clearInterval(i.timer)))},fillZero:function(t){return t<10&&(t="0"+t),t},init:function(){var t=this;if(new Date(a.endtime)<=new Date(a.starttime))throw new Error("å€’è®¡æ—¶çš„å¼€å§‹æ—¶é—´ä¸èƒ½å¤§äºŽç»“æŸæ—¶é—´~");this.timer=setInterval(function(){t.setHtml(t.countDown())},10)}}).init()})}}(jQuery,window);
